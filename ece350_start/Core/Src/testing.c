...
//	osKernelStart();
	...
	while (1)
	{
		...
		DEBUG_PRINTF("Type of Block List 0: %x\r\n", buddyHeap.blockList[0].type);
		DEBUG_PRINTF("Address of Block List 0 (Starting Address): %x\r\n", buddyHeap.blockList[0].startingAddress);
		...
		DEBUG_PRINTF("TID of Owner of Block List 0: %x\r\n", buddyHeap.blockList[0].TIDofOwner);
		DEBUG_PRINTF("Size of Block List 0: %d\r\n", buddyHeap.blockList[0].size);
		/* USER CODE BEGIN 3 */
	}
	/* USER CODE END 3 */
}
